...
import { FormReceiptVoucher } from '@/components/pages/voucher/receipt/form-receipt-voucher';
import { ShowReceiptVoucher } from '@/components/pages/voucher/receipt/show-receipt-voucher';
