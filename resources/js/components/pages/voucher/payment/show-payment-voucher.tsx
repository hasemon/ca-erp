...
import { PaymentVoucherPDF } from '@/components/pages/voucher/payment/payment-voucher-pdf';
import {
    AlertDialog,
    AlertDialogAction,
    AlertDialogCancel,
...
interface ShowPaymentVoucherProps {
    voucher: VoucherType;
    onEdit: () => void;
    onDeleted?: () => void;
}

export function ShowPaymentVoucher({
    voucher,
    onEdit,
    onDeleted,
}: ShowPaymentVoucherProps) {
    ...
    const printVoucher = async () => {
        await handlePrint({
            pdfDocument: <PaymentVoucherPDF voucher={voucher} />,
    ...
    const handleDelete = () => {
        router.delete(payment.destroy.url(voucher.id), {
            preserveScroll: true,
            onSuccess: () => {
